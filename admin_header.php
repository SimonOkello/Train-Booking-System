                ...
                <div class="container cf">
                    ...
                    <!-- END: LANG -->
                     ...
                     <div class="enter header__item">
                        ...
                        <a href="logout.php" class="enter__item enter__item_login">Log Out</a>
                    </div>
                    <!-- END: ENTER -->
...
echo $_SESSION["username"];
      ...
      echo "<script type='text/javascript'>alert('You must log in first'); window.location.href = 'admin_login.php';</script>";
}
  ...
  ?>
        ...
        <div class="mainSlider">
            <ul class="insMainSlider cf">
                <li class="insMainSlider__item" style="background: url() no-repeat center center fixed;">
                    <div class="container">
